    ...
    <PageShell>
      <section className="mx-auto max-w-3xl px-4 py-14">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <a href="https://wa.me/" target="_blank" rel="noreferrer" className="card-elevated flex flex-col items-center gap-3 p-6 text-center">
          ...
          <a href="https://instagram.com" target="_blank" rel="noreferrer" className="card-elevated flex flex-col items-center gap-3 p-6 text-center">
            <div className="grid h-12 w-12 place-items-center rounded-2xl bg-brand-soft" style={{ color: "var(--brand)" }}>
              <Instagram className="h-5 w-5" />
            </div>
            <div className="font-semibold text-primary">Instagram</div>
            <div className="text-xs text-muted-foreground">@socomprar</div>
          </a>
